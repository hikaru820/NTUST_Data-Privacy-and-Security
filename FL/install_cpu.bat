@echo off
REM ============================================================
REM  CPU installer (fallback)
REM  For: No GPU or testing the pipeline
REM  Note: CIFAR-100 + FL on CPU is slow, only for flow testing
REM ============================================================

cd /d "%~dp0"
echo.
echo === FL Environment Setup: CPU only ===
...
REM --- 5. Install PyTorch (CPU) + common packages ---
echo [STEP 4/4] Installing torch CPU and dependencies ...
echo.

pip install torch torchvision --index-url https://download.pytorch.org/whl/cpu
if errorlevel 1 (
    echo [ERROR] torch CPU installation failed.
    pause
    exit /b 1
)
